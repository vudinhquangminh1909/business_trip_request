...
import { CreateUpdateCategoryDTO, SystemCategoryService, CategoryType } from '@proxy/category';
import { CreateUpdateTripInformationDTO, TripInformationService } from '@proxy/business-trip';
